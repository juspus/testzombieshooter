...
export default function Arena() {
  return (
    <group>
      ...
      <pointLight position={[0, WH - 0.5, 0]} intensity={20} color="#ffe0aa" castShadow distance={35} decay={2} />
      <pointLight position={[-5, 1.5, -5]} intensity={4} color="#ffcc88" distance={14} decay={2} />
      <pointLight position={[ 5, 1.5,  5]} intensity={4} color="#ffcc88" distance={14} decay={2} />
