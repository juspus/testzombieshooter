...
export default function Arena() {
  return (
    <group>
      ...
      <pointLight position={[0, WH - 0.5, 0]} intensity={12} color="#ff8833" castShadow distance={28} decay={2} />
      <pointLight position={[-5, 1.5, -5]} intensity={1.8} color="#ff7722" distance={10} decay={2} />
      <pointLight position={[ 5, 1.5,  5]} intensity={1.8} color="#ff7722" distance={10} decay={2} />
